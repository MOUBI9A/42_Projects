...
/*   Updated: 2024/05/10 15:54:32 by hel-moue         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string t_name) : name(t_name), hit_points(10), energy_points(10), attack_damage(0) {
    std::cout << "ClapTrap constructor called" << std::endl;
}

ClapTrap::ClapTrap(std::string t_name, int damage) : name(t_name), hit_points(10), energy_points(10), attack_damage(damage) {
    std::cout << "ClapTrap constructor called" << std::endl;
}
